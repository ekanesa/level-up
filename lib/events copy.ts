...
export function updateEvent(
  ...
  stmt.run(
    ...
    // - null => set null
    data.end_date !== undefined ? data.end_date : (current as any).end_date ?? null,
    data.shift_duration !== undefined ? data.shift_duration : (current as any).shift_duration ?? null,
    data.requirements !== undefined ? data.requirements : (current as any).requirements ?? null,
    data.what_we_offer !== undefined ? data.what_we_offer : (current as any).what_we_offer ?? null,
